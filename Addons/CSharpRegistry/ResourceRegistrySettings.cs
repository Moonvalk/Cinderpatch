...
namespace Moonvalk.Resources
{
    ...
    public static class ResourceRegistrySettings
    {
        ...
        /// </summary>
        public static string ClassPrefix => GetSettings(nameof(ClassPrefix))
            .ToString();
        ...
        private static void AddSetting(string title_, Variant.Type type_, object value_, PropertyHint hint_ = PropertyHint.None,
            string hintString_ = "")
        {
