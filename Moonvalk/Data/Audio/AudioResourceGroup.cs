...
namespace Moonvalk.Data
{
    ...
    public class AudioResourceGroup : MoonStringArray
    {
        ...
        /// </summary>
        [Export] public AudioResourcePlayType LoopType { get; private set; } = AudioResourcePlayType.Ordered;

        /// <summary>
        /// The initial play type used when an audio resource must be selected.
        /// </summary>
        [Export] public AudioResourcePlayType InitialPlayType { get; private set; } = AudioResourcePlayType.Random;
        ...
        {
            if (index_ > Items.Length - 1)
            {
                index_ = 0;
            }

            _currentIndex = index_;
            return Items[_currentIndex].AsPath;
        }
