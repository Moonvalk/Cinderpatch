...
namespace Moonvalk.Animation
{
    ...
    public class MoonWobbleGroup
    {
        ...
        {
            if (WobbleHandlers.TryGetValue(property_, out var handler))
            {
                return handler
                    ?.GetWobble<Unit>();
            }
        ...
        public void Clear()
        {
            ...
            foreach (var handler in WobbleHandlers.Values)
            {
                handler?.Delete();
            }
        ...
        private BaseMoonWobble<Unit> AddProperty<Unit>(MoonWobbleProperty property_, IMoonWobbleHandler wobbleHandler_)
        {
        ...
        /// <typeparam name="Unit">The unit type used for animating.</typeparam>
        /// <param name="property_">The property that will be animated.</param>
        private void RemoveProperty<Unit>(MoonWobbleProperty property_)
        {
