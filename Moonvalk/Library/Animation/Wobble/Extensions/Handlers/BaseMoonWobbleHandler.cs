...
namespace Moonvalk.Animation
{
        ...
        where WobbleType : BaseMoonWobble<Unit>, new()
    {
        ...
        {
            return (IMoonWobble<WobbleValue>)_wobble;
        }
        ...
        private void BindData(ref ParentType object_, MoonWobbleProperty property_)
        {
            _values = GetInitialPropertyValues(ref object_, property_);
            _onUpdate = AssignUpdateAction(ref object_, property_);
        }
