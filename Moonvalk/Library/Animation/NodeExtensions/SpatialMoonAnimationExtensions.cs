...
namespace Moonvalk.Animation
{
    ...
    public static class SpatialMoonAnimationExtensions
    {
        ...
        /// <param name="start_">Flag that determines if this animation should start immediately.</param>
        /// <returns>Returns the newly created MoonWobble object for further adjustments / handling.</returns>
        public static MoonWobbleVec3 WobbleRotation(this Spatial object_, Vector3 percentage_, MoonWobbleParams parameters_ = null,
            bool start_ = true)
        {
        ...
        {
            return (MoonWobbleVec3)MoonWobbleExtensions.GetMoonWobbleGroup(object_)
                ?.GetWobble<Vector3>(MoonWobbleProperty.Rotation)
                .Stop();
        }
        ...
        {
            return (MoonWobbleVec3)MoonWobbleExtensions.GetMoonWobbleGroup(object_)
                ?.GetWobble<Vector3>(MoonWobbleProperty.Scale)
                .Stop();
        }
        ...
        {
            return (MoonWobbleVec3)MoonWobbleExtensions.GetMoonWobbleGroup(object_)
                ?.GetWobble<Vector3>(MoonWobbleProperty.Position)
                .Stop();
        }
