...
namespace Moonvalk.Animation
{
    ...
    public static class Node2DMoonAnimationExtensions
    {
        ...
        {
            return (MoonWobble)MoonWobbleExtensions.GetMoonWobbleGroup(object_)
                ?.GetWobble<float>(MoonWobbleProperty.Rotation)
                .Stop();
        }
        ...
        {
            return (MoonWobbleVec2)MoonWobbleExtensions.GetMoonWobbleGroup(object_)
                ?.GetWobble<Vector2>(MoonWobbleProperty.Scale)
                .Stop();
        }
        ...
        {
            return (MoonWobbleVec2)MoonWobbleExtensions.GetMoonWobbleGroup(object_)
                ?.GetWobble<Vector2>(MoonWobbleProperty.Position)
                .Stop();
        }
        ...
        {
            return (MoonWobbleColor)MoonWobbleExtensions.GetMoonWobbleGroup(object_)
                ?.GetWobble<Color>(MoonWobbleProperty.Color)
                .Stop();
        }
