...
namespace Moonvalk.Animation
{
    ...
    public class MoonTweenGroup
    {
        ...
        {
            if (TweenHandlers.TryGetValue(property_, out var handler))
            {
                return handler
                    ?.GetTween<Unit>();
            }
        ...
        public void Clear()
        {
            ...
            foreach (var handler in TweenHandlers.Values)
            {
                handler.Delete();
            }
        ...
        private BaseMoonTween<Unit> AddProperty<Unit>(MoonTweenProperty property_, IMoonTweenHandler tweenHandler_)
        {
        ...
        /// <typeparam name="Unit">The unit type used for animating.</typeparam>
        /// <param name="property_">The property that will be animated.</param>
        private void RemoveProperty<Unit>(MoonTweenProperty property_)
        {
