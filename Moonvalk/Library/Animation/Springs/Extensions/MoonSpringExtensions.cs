...
namespace Moonvalk.Animation
{
    ...
    public static class MoonSpringExtensions
    {
        ...
        /// </summary>
        private static readonly Dictionary<Node, MoonSpringGroup> SpringGroups = new Dictionary<Node, MoonSpringGroup>();
        ...
        public static void ClearAll()
        {
            ...
            {
                foreach (var group in SpringGroups.Values)
                {
                    group?.Clear();
                }
