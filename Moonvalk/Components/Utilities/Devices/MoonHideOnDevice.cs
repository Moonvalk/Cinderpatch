...
namespace Moonvalk.Components
{
    ...
    public class MoonHideOnDevice : Node
    {
        ...
        /// </summary>
        [Export] protected NodePath[] PElementsToHideOnMobile { get; private set; }

        /// <summary>
        /// True to hide these elements on mobile.
        /// </summary>
        [Export] public bool HideOnMobile { get; private set; } = true;

        /// <summary>
        /// True to hide these elements on HTML5 web.
        /// </summary>
        [Export] public bool HideOnHtml5 { get; private set; }

        /// <summary>
        /// True to hide these elements on desktop.
        /// </summary>
        [Export] public bool HideOnDesktop { get; private set; }
        ...
        public override void _Ready()
        {
            ...
            if (HideOnHtml5 && DeviceHelpers.IsDeviceHtml5())
            {
                isPlatform = false;
            }

            if (HideOnMobile && DeviceHelpers.IsDeviceMobile())
            {
                isPlatform = false;
            }
