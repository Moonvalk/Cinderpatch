...
namespace Moonvalk.Components
{
        ...
        where SceneType : Node where DataType : MoonValueArray<DataType>
    {
        ...
        public override void _Ready()
        {
            ...
            {
                Display(DefaultSceneIndex);
            }

            _transitionAnimator = this.GetComponent<BaseSceneTransitionAnimator>();
        ...
        /// </summary>
        private BaseSceneTransitionAnimator _transitionAnimator;
        ...
        public bool Display(string sceneName_)
        {
            ...
            {
                if (formattedName == Scenes.Items[index]
                        .Name.ToLower())
                {
