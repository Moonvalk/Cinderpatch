...
namespace Moonvalk.Components
{
    public class BaseSceneLoadAnimator : Control
    {
        ...
        {
            Visible = false;
            MoonResourceLoader.Load<PackedScene>(PathAnimation.AsPath,
                scene_ => { Animation = this.AddInstance<BaseSceneLoadAnimation>(scene_); });
        ...
        /// </summary>
        [Export] protected MoonString PathAnimation { get; private set; }
